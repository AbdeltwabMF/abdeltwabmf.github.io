...
draft: false
summary: 'Learn how to suspend and hybernate non-just-works distro like arch linux'
---
...
1. Uncomment all parameters in Sleep section and update `SuspendMode=suspend` in file `/etc/elogind/logind.conf`.
